...
class Ui_ExtendedErrorBarDialog(object):
    ...
    def retranslateUi(self, ExtendedErrorBarDialog):
        ...
        self.cboPercentageOrSeqCount.setItemText(0, QtWidgets.QApplication.translate("ExtendedErrorBarDialog", "Sequences", None, QtWidgets.QApplication.UnicodeUTF8))
        self.cboPercentageOrSeqCount.setItemText(1, QtWidgets.QApplication.translate("ExtendedErrorBarDialog", "Proportion (%)", None, QtWidgets.QApplication.UnicodeUTF8))
