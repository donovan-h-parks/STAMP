...
#
# Abstract base class specifying interface of a multiple group confidence interval method.
#
...
class AbstractMultiGroupConfIntervMethod:
  '''
  Abstract base class specifying interface of a multiple group confidence interval method.
  '''
  ...
  def run(self, sampleData, coverage):
    '''
