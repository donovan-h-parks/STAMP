...
class Ui_multCompCorrectionInfoDlg(object):
    def setupUi(self, multCompCorrectionInfoDlg):
        ...
        self.layout.setFieldGrowthPolicy(QtWidgets.QFormLayout.FieldGrowthPolicy.AllNonFixedFieldsGrow)
    ...
    def retranslateUi(self, multCompCorrectionInfoDlg):
        multCompCorrectionInfoDlg.setWindowTitle(QtWidgets.QApplication.translate("multCompCorrectionInfoDlg", "Additional info", None))
